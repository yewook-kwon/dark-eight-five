...
gradient1.addColorStop(0, 'rgba(19, 100, 137, 1.0)');
gradient1.addColorStop(1, 'rgba(19, 100, 137, 0.3)');
    ...
    options: {
        ...
        scales: {
            ...
            y: {
                ...
                beginAtZero: false,
                grid: {
                    color: 'rgba(22, 53, 86, 1)',
                },
                ticks: {
                    color: '#688ba4' // y축 폰트 색상 변경
                }
            }
        }
    }
...
gradient2.addColorStop(0, 'rgba(19, 100, 137, 1.0)');
gradient2.addColorStop(1, 'rgba(19, 100, 137, 0.3)');
